...
public class VideoRenderer3 extends RajawaliCardboardRenderer {
    ...
    public VideoRenderer3(Activity activity) {
        super(activity);

        mainActivity3 = (MainActivity3) activity;
    }
    ...
    public void initScene() {
        ...
        mMediaPlayer = MediaPlayer.create(getContext(), Splash.videos[Splash.order.get(2)]);
